...
[English](./README.md) · [在线阅读](https://aprilwang2024.github.io/ai-worldline/) · [查看数据](./data/timeline.json) · [建议新条目](../../issues/new?template=add-event.yml)
...
“世界模型”等主题是横跨两条主轴的专题切面。每个条目都回答“发生了什么 / 为什么重要 / 改变了什么”，并尽量回到论文全文、代码仓库和机构官方发布。
